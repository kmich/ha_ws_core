...
SENSORS: list[WSSensorDescription] = [
    ...
    # =========================================================================
    WSSensorDescription(
        key=KEY_TEMP_HIGH_YEAR,
        translation_key="temperature_high_year",
        name="WS Temperature High Year",
        icon="mdi:thermometer-high",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        attrs_fn=lambda d: {"year_ref": d.get(KEY_TEMP_YEAR_REF)},
    ),
    WSSensorDescription(
        key=KEY_TEMP_LOW_YEAR,
        translation_key="temperature_low_year",
        name="WS Temperature Low Year",
        icon="mdi:thermometer-low",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    WSSensorDescription(
        key=KEY_TEMP_HIGH_ALL_TIME,
        translation_key="temperature_high_all_time",
        name="WS Temperature High All Time",
        icon="mdi:thermometer-chevron-up",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    WSSensorDescription(
        key=KEY_TEMP_LOW_ALL_TIME,
        translation_key="temperature_low_all_time",
        name="WS Temperature Low All Time",
        icon="mdi:thermometer-chevron-down",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    # All-time longest streak ever recorded (issue #127); never resets, even
    # when the current running streak above breaks.
    WSSensorDescription(
        key=KEY_DRY_STREAK_RECORD,
        translation_key="dry_streak_record",
        name="WS Dry Streak Record",
        icon="mdi:water-off",
        native_unit=None,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    WSSensorDescription(
        key=KEY_HEAT_STREAK_RECORD,
        translation_key="heat_streak_record",
        name="WS Heat Streak Record",
        icon="mdi:thermometer-high",
        native_unit=None,
        state_class=SensorStateClass.MEASUREMENT,
        attrs_fn=lambda d: {"threshold_c": d.get("_heat_streak_threshold_c")},
    ...
    WSSensorDescription(
        key=KEY_FROST_STREAK_RECORD,
        translation_key="frost_streak_record",
        name="WS Frost Streak Record",
        icon="mdi:snowflake",
        native_unit=None,
        state_class=SensorStateClass.MEASUREMENT,
        attrs_fn=lambda d: {"threshold_c": d.get("_frost_streak_threshold_c")},
    ...
    # v2.7 — Historical climate normals (day-of-year, vs. long-term history —
    # distinct from the self-referential 30d/90d anomalies above)
    WSSensorDescription(
        key=KEY_TEMP_HIGH_NORMAL,
        translation_key="temp_high_normal",
        name="WS Temperature High (Normal)",
        icon="mdi:thermometer-lines",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
        attrs_fn=lambda d: {
            "sample_years": d.get(KEY_CLIMATE_NORMALS_YEARS),
            "fetched_at": d.get(KEY_CLIMATE_NORMALS_FETCHED),
        },
    ),
    WSSensorDescription(
        key=KEY_TEMP_LOW_NORMAL,
        translation_key="temp_low_normal",
        name="WS Temperature Low (Normal)",
        icon="mdi:thermometer-lines",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    WSSensorDescription(
        key=KEY_RAIN_NORMAL_MM,
        translation_key="rain_normal",
        name="WS Rain (Normal)",
        icon="mdi:weather-rainy",
        native_unit=UNIT_RAIN_MM,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    WSSensorDescription(
        key=KEY_TEMP_ANOMALY_NORMAL,
        translation_key="temp_anomaly_normal",
        name="WS Temperature Anomaly (Normal)",
        icon="mdi:thermometer-alert",
        device_class=SensorDeviceClass.TEMPERATURE,
        native_unit=UNIT_TEMP_C,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    WSSensorDescription(
        key=KEY_RAIN_ANOMALY_NORMAL,
        translation_key="rain_anomaly_normal",
        name="WS Rain Anomaly (Normal)",
        icon="mdi:weather-rainy",
        native_unit=UNIT_RAIN_MM,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
...
_FEATURE_TOGGLE_MAP: dict[str, str] = {
    ...
    # v2.7 - historical climate normals
    KEY_TEMP_HIGH_NORMAL: CONF_ENABLE_CLIMATE_NORMALS,
    KEY_TEMP_LOW_NORMAL: CONF_ENABLE_CLIMATE_NORMALS,
    KEY_RAIN_NORMAL_MM: CONF_ENABLE_CLIMATE_NORMALS,
    KEY_TEMP_ANOMALY_NORMAL: CONF_ENABLE_CLIMATE_NORMALS,
    KEY_RAIN_ANOMALY_NORMAL: CONF_ENABLE_CLIMATE_NORMALS,
